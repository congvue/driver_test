...
static int s5k5ba_power_en(int onoff) {
	...
	printk("s5k5ba: power %s\n", onoff ? "ON" : "Off");
	return 0;
}

static struct s5k5ba_platform_data s5k5ba_plat = {
	.default_width = 1280,
	.default_height = 1024,
...
static int GC2015_power_en(int onoff) {
	int ret;
...
static struct s3c_platform_camera GC2015 = {
	...
	.initialized	= 0,
	.cam_power	= GC2015_power_en,
};
#endif

//friendly_arm ov9650_driver
...
static struct i2c_board_info tvp5150_i2c_info = {
	2C_BOARD_INFO("tvp5150", (0xb8 >> 1)),
};

static struct s3c_platformv9650_pl_camera tvp5150 = {
	#ifdef CAM_ITU_CH_A
	.id		= CAMERA_PAR_A,
	#else
	.id		= CAMERA_PAR_B,
...
#ifdef CONFIG_SENSORS_QMC5983
#include <linux/QMC5983.h>
static struct QMC5983_platform_data qmc5983_pdata = {
	.h_range = 0,  //TODO: What is h_range use for ?
	.negate_x = 1,
	.negate_y = 1,
	.negate_z = 1,
	.axis_map_x = 1,
...
static struct i2c_board_info mini210_i2c_devs0[] __initdata = {
	...
	{
		I2C_BOARD_INFO("afa750", 0x3D),
	},

#endif
#ifdef CONFIG_SENSORS_QMC5983
	{
		I2C_BOARD_INFO("QMC5983", 0x1e),
		.platform_data = &qmc5983_pdata,
	},
#endif
};
...
//add by zhangq
#ifdef CONFIG_TOUCHSCREEN_FT5X0X
//	ft5x0x_pdata.x_max = lcd->width;
//	ft5x0x_pdata.y_max = lcd->height;
#endif
}
